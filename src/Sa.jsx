...
// Data: Hiragana characters and their corresponding Romaji (for 'sa', 'shi', 'su', 'se', 'so')
const hiraganaData = [
...
const Sa = () => {
  ...
  const generateNewQuestion = () => {
    ...
    // Create a fixed list of all possible answers (always sa, shi, su, se, so)
    const allAnswers = ['sa', 'shi', 'su', 'se', 'so'];
